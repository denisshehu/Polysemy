...
class WordCollection:
    ...
    def __init__(self, corpus_path, embeddings_path, senses_path, word_collection_path, words=None,
        ...
        self._used_n_total_senses = used_n_total_senses
    ...
    @property
    def used_n_total_senses(self):
        return self._used_n_total_senses

    @used_n_total_senses.setter
    def used_n_total_senses(self, used_n_total_senses):
        self._used_n_total_senses = used_n_total_senses
    ...
    def get_monosemes(self, n=None, use_n_total_senses=True):
        ...
        monosemes.used_n_total_senses = use_n_total_senses
        return monosemes
    ...
    def get_polysemes(self, n=None, use_n_total_senses=True):
        ...
        polysemes.used_n_total_senses = use_n_total_senses
        return polysemes

    def get_monosemes_and_polysemes(self, n=None, use_n_total_senses=True):
        monosemes = self.get_monosemes(n, use_n_total_senses)
        polysemes = self.get_polysemes(n, use_n_total_senses)
        words = monosemes.words
        words.update(polysemes.words)
        return WordCollection(self._corpus_path, self._embeddings_path, self._senses_path, self._word_collection_path,
                              words, use_n_total_senses)
