...
def calculate(point_cloud, neighborhood_size, n_steps, filename_prefix=None):
    calculate_in_parallel(point_cloud, neighborhood_size, n_steps)
    # save_point_cloud(point_cloud, filename_prefix)
    # print('Euclidicity calculated.')


def calculate_in_parallel(point_cloud, neighborhood_size, n_steps):
