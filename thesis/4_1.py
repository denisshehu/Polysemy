...
plot_3d_scatterplot(points, values, hide_x_tick_labels=True, hide_y_tick_labels=True, hide_z_tick_labels=True,
                    hide_color_bar=True, figure_name='sphere', figure_size=figure_size)
...
values = [p[0] for p in points]
plot_3d_scatterplot(points, values, hide_x_tick_labels=True, hide_y_tick_labels=True, hide_z_tick_labels=True,
                    hide_color_bar=True, figure_name='ball', figure_size=figure_size)
...
values = [p[0] for p in points]
plot_3d_scatterplot(points, values, hide_x_tick_labels=True, hide_y_tick_labels=True, hide_z_tick_labels=True,
                    hide_color_bar=True, figure_name='cones', figure_size=figure_size)
...
plot_3d_scatterplot(points, values, hide_x_tick_labels=True, hide_y_tick_labels=True, hide_z_tick_labels=True,
                    hide_color_bar=True, figure_name='planes', figure_size=figure_size)
