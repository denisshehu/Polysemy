...
for i, threshold in enumerate(thresholds):
    ...
    for neighborhood_size in neighborhood_sizes:
        ...
        summary[i].append([query.intrinsic_dimension for query in point_cloud.queries][0])
...
y1_label, y2_label, y3_label = f'Threshold {thresholds[0]}', f'Threshold {thresholds[1]}', f'Threshold {thresholds[2]}2-'
x_label, y_label = 'Neighborhood cardinality', 'Estimated intrinsic dimension'
padding = 0.05
x_padding = padding * (neighborhood_sizes[-1] - neighborhood_sizes[0])
min_x, max_x = neighborhood_sizes[0] - x_padding, neighborhood_sizes[-1] + x_padding
min_y, max_y = 0, 3
figure_name = f'summary'
figure_size = (10, 4.8)
plot_line_plot(neighborhood_sizes, summary[0], summary[1], summary[2], y1_label, y2_label, y3_label, x_label, y_label,
               min_x, max_x, min_y, max_y, a=intrinsic_dimension, figure_name=figure_name, figure_size=figure_size)
