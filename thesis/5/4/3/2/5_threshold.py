...
from methods.euclidicity_versions.euclidicity_scaling_constant_filtering import *
...
thresholds = [0.0025 * (i + 1) for i in range(8)]
...
for i, threshold in enumerate(thresholds):
    prefix = f'{i + 1}_threshold{threshold:.4f}'
